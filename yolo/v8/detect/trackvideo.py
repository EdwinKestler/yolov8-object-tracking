...
output_writer = None  # Define a global VideoWriter object
...
class DetectionPredictor(BasePredictor):
    ...
    def preprocess(self, img):
        ...
        img /= 255  # Scale from 0-255 to 0.0-1.0
        return img
    ...
    def write_results(self, idx, preds, batch):
        ...
        if output_writer is None:
            ...
            fps = 30  # Set FPS as per your requirements
            fourcc = cv2.VideoWriter_fourcc(*"mp4v")
            output_writer = cv2.VideoWriter(output_file, fourcc, fps, (width, height))
...
def predict(cfg):
    ...
    # Release VideoWriter at the end of processing
    global output_writer
